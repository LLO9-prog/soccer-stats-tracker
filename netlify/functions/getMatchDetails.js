...
function generateMockEvents() {
  return [
    { minute: 23, type: 'GOAL', team: 'home', player: '前鋒球員', description: '精彩射門得分' },
    { minute: 34, type: 'YELLOW_CARD', team: 'away', player: '後衛球員', description: '戰術犯規' },
    { minute: 45, type: 'GOAL', team: 'away', player: '中場核心', description: '自由球直接破門' },
    { minute: 67, type: 'SUBSTITUTION', team: 'home', player: '替補前鋒', description: '加強進攻' },
    { minute: 78, type: 'GOAL', team: 'home', player: '隊長', description: '頭槌破門' }
  ];
}
...
function generateMockLineups() {
  return {
    home: [
      { number: 1, name: '門將', position: 'GK' },
      { number: 2, name: '右後衛', position: 'DF' },
      { number: 5, name: '中後衛', position: 'DF' },
      { number: 6, name: '中後衛', position: 'DF' },
      { number: 3, name: '左後衛', position: 'DF' },
      { number: 8, name: '中場', position: 'MF' },
      { number: 16, name: '防守中場', position: 'MF' },
      { number: 17, name: '進攻中場', position: 'MF' },
      { number: 7, name: '右邊鋒', position: 'FW' },
      { number: 9, name: '前鋒', position: 'FW' },
      { number: 11, name: '左邊鋒', position: 'FW' }
    ],
    away: [
      { number: 13, name: '門將', position: 'GK' },
      { number: 4, name: '右後衛', position: 'DF' },
      { number: 5, name: '中後衛', position: 'DF' },
      { number: 6, name: '中後衛', position: 'DF' },
      { number: 3, name: '左後衛', position: 'DF' },
      { number: 8, name: '中場', position: 'MF' },
      { number: 25, name: '防守中場', position: 'MF' },
      { number: 10, name: '進攻中場', position: 'MF' },
      { number: 7, name: '右邊鋒', position: 'FW' },
      { number: 9, name: '前鋒', position: 'FW' },
      { number: 11, name: '左邊鋒', position: 'FW' }
    ]
